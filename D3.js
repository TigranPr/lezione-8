...
const array="starWarsCharacters"
for(let i=0; i < starWarsCharacters.length; i++){
console.log(starWarsCharacters[i].name);
starWarsCharacters.push(starWarsCharacters[i].name);
}
console.log(starWarsCharactersName);

/* ESERCIZIO 3
  Seguendo i passaggi precedenti crea un nuovo array chiamato "femaleCharacters" e inserisci al suo interno tutti gli oggetti femminili.
*/

const arra= "femaleCharacters"
...
for(leti=0;i< starWarsCharacters.length; i++){
...
for(let i=0; i < characters.length; i++ ){
  for (let j=0; j<femaleCharacters.length; j++) {
   if (characters[i].mame === characters[j]);
